section "Creating header and cards for the homepage" do
  ...
  Widget::Card.create!(
    title_en: "Kavak Petitions",
    title_es: "Kavak Petitions",

    description_en: "Free software for kavakers participation.",
    description_es: "Software libre para la participación de kavakos.",
  ...
  Widget::Card.create!(
    title_en: "How do proposals work?",
    title_es: "¿Cómo funcionan las propuestas?",

    description_en: "A space for everyone to create a kavaker's proposal and seek supports. "\
                    "Proposals which reach to enough supports will be voted and so, together we "\
                    "can decide the issues that matter to us.",
    description_es: "Un espacio para que el kavako cree una propuesta y busque apoyo. "\
  ...
  Widget::Card.create!(
    ...
    description_en: "Participatory budgets allow kavakers to propose and decide directly "\
    ...
    description_es: "Los presupuestos participativos permiten que los kavakos propongan y  "\
